...
function play(){
  ...
  images.forEach(function(image) {
    ...
    image.setAttribute('src', 'resources/images/game/question-mark.webp'); 
  });
...
function setGameImages(element) {
  ...
  images.forEach(function(image) { 
    ...
    if(image.getAttribute('data-value') == "1"){
      image.setAttribute('src', 'resources/images/game/dog-play.webp');      
    }else if(image.getAttribute('data-value') == "2"){
      image.setAttribute('src', 'resources/images/game/cat-play.webp');      
    }else{
...
// Image paths
var images = ['resources/images/carousel/puppies1.webp', 'resources/images/carousel/puppies2.webp', 'resources/images/carousel/puppies3.webp'];
