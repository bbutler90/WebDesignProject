...
function play(){
  ...
  images.forEach(function(image) {
    ...
    image.setAttribute('src', 'resources/images/game/question-mark.png'); 
  });
...
function setGameImages(element) {
  ...
  images.forEach(function(image) { 
    ...
    if(image.getAttribute('data-value') == "1"){
      image.setAttribute('src', 'resources/images/game/dog-play.png');      
    }else if(image.getAttribute('data-value') == "2"){
      image.setAttribute('src', 'resources/images/game/cat-play.png');      
    }else{
...
// Image paths
var images = ['resources/images/carousel/puppies1.jpg', 'resources/images/carousel/puppies2.jpg', 'resources/images/carousel/puppies3.jpg'];
